...
export default function TitleDetailsPage({
  ...
  return (
    <article className="min-h-screen">
      ...
      {/*
        `relative z-10` é essencial aqui: a secção do backdrop acima é
        `position: relative`, o que a coloca automaticamente num contexto de
        empilhamento acima de elementos não posicionados — mesmo que estes
        venham depois no HTML. Sem isto, o poster ficava visualmente por
        baixo do backdrop na zona de sobreposição (-mt-20).
      */}
      <div className="relative z-10 mx-auto -mt-20 max-w-content px-6 pb-20 md:px-10">
